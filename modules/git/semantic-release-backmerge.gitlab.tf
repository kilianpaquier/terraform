resource "gitlab_project" "semantic-release-backmerge" {
  ...
  import_url                          = "https://github.com/kilianpaquier/semantic-release-backmerge.git"
  mirror                              = true
...
module "gitlab_semantic-release-backmerge" {
  depends_on = [
