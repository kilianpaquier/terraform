module "gitlab_project_dotfiles" {
...
module "gitlab_project_settings_dotfiles" {
  depends_on = [
  ...
  project            = module.gitlab_project_dotfiles.id
  ...
  mirror = {
    ...
    url   = module.github_repository_dotfiles.http_clone_url
  }
}
